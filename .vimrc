...
func SetComment()  
    ...
    call append(line(".")+4, "*   > Created Time：".strftime("%Y-%m-%d [%H:%M:%S] (%A)"))   
...
func SetComment_shell()
    ...
    call append(line(".")+5, "#   > Created Time：".strftime("%Y-%m-%d [%H:%M:%S] (%A)"))
...
func SetComment_python() 
    ...
    call append(line(".")+6, "#   > Created Time：".strftime("%Y-%m-%d [%H:%M:%S] (%A)"))
